  ...
  return (
    <div className='border border-gray-300 rounded-2xl p-10 max-w-[450px] mx-auto space-y-4 '>
      ...
      <div className='flex justify-between'>
        ...
        <span className=
        {`${card.tag === 'new' ? 'bg-green-300 text-green-800' : card.tag === 'popular' ? 'bg-purple-400 text-purple-800' : card.tag=== 'best seller' ? 'bg-yellow-400 text-yellow-700': ''} rounded-2xl p-2`}
        >{card.tag}</span>
      </div>
